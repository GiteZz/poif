...
def get_dataset_info(git_url: str, commit: str) -> DatasetInfo:
    ds_url = f'{git_url}?c={commit}'
    ...
    new_ds_info = DatasetInfo(files=data_files, id=ds_key, s3_config=remote_config)
