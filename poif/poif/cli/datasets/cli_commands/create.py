...
def create(args):
    ...
    dataset_config = VersionedDatasetConfig.load()
...
def create_readme(dataset_config: VersionedDatasetConfig):
    readme_tools.create_readme(dataset_config, git_add=True, git_commit=True)


def create_interface(dataset_config: VersionedDatasetConfig):
